...
var previewBlogComponent = React.createClass({
    ...
    render: function() {
        ...
        //var body = this.props.blogpost.body.length > 1000 ? this.props.blogpost.body.substring(0, 1000) + "..." + "</p>": this.props.blogpost.body;

        var author = this.props.blogpost.author ? this.props.blogpost.author.fullname : "Magination";
        ...
        return (
            <div className="blogPostPreview">
                ...
                <div className="blog-preview-body" dangerouslySetInnerHTML={{__html: this.body()}}/>
    ...
    body: function() {
        return this.props.blogpost.body.split("</p>")[0] + "...</p>";
    }
});
